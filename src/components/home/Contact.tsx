    ...
    <section id="contact">
      <div className="container ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-md mb-md ">
          {/* Contact Info */}
          <div className="glass-effect ring-1 ring-gray-200 ring-opacity-50">
          ...
          {/* Contact Form */}
          <div className="glass-effect ring-1 ring-gray-200 ring-opacity-50">
            <h3 className="text-2xl mb-sm">تواصل معنا الآن!</h3>
        ...
        {/* Map */}
        <div className="glass-effect text-center ring-1 ring-gray-200 ring-opacity-50">
          <h3 className="text-2xl mb-sm">موقعنا</h3>
          <div className="max-w-2xl mx-auto overflow-hidden pb-[35%] relative h-0 mt-sm">
            <iframe 
